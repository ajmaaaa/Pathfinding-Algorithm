...
def draw_pohon(surface, origin_x, origin_y):
    # Menggambar sebatang pohon gaya PohonBelakang sebagai pengganti Pohon Pinus
    buat_sebatang_pohon(surface, origin_x, origin_y, scale=2.0)

# Alias untuk kompatibilitas
draw_pohon_pinus = draw_pohon
